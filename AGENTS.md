...
- **`KeystoreHelperTest` New Tests and Re-enabled Tests**: 7 new tests covering all combinations of the new `createKeyPair` parameters (RSA + EC, various API-level guards). Removed `@Ignore` from 2 previously skipped tests (`createKeyPair_happyPathOverwriteDefaultsCase2of4`, `createKeyPair_happyPathOverwriteDefaultsCase4of4`).
